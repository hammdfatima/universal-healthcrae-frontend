...
export default function AdminNotificationDropdown() {
  ...
  useEffect(() => {
    setNotifications(getAdminNotificationsFromStorage())
  }, [])

  const unreadCount = getUnreadAdminNotificationCount(notifications)

  function updateNotifications(next: AdminNotification[]) {
    setNotifications(next)
    saveAdminNotificationsToStorage(next)
  }
