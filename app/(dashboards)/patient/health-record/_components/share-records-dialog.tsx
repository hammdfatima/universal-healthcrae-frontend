...
type ShareRecordsDialogProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
}

export default function ShareRecordsDialog({
  open,
  onOpenChange,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="gap-0 overflow-hidden p-0 sm:max-w-lg">
            ...
            <div>
              ...
              <DialogDescription className="mt-1">
                {isManagedMember
                  ...
                  : "Choose which family members can view your medical vault. Sharing is off by default."}
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
        ...
        {hasHousehold && !isLoading && !isError ? (
