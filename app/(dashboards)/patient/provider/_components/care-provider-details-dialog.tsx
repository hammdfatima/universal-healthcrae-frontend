  ...
  return (
    <>
        ...
        <DialogContent className="gap-0 overflow-hidden p-0 sm:max-w-lg">
          ...
          <div className="space-y-4 px-6 py-5">
            ...
            <DetailRow
              icon={Mail}
              label="Email"
              value={formatOptionalEmail(provider.email)}
            />
            <DetailRow
              icon={Building2}
          ...
          <div className="flex flex-row flex-wrap items-center gap-2 border-t border-border/60 bg-muted/20 px-6 py-4">
            ...
            >
              <Link
                href={`/patient/provider/${provider.id}/edit`}
      ...
      <AlertDialog open={deleteOpen} onOpenChange={setDeleteOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Delete care provider?</AlertDialogTitle>
            <AlertDialogDescription>
              This will permanently remove {provider.name} from your care team.
