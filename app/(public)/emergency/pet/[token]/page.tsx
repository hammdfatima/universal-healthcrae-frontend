...
function PetEmergencyProfileView({
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 px-5 pb-24 pt-8 sm:px-6 sm:pb-10 sm:pt-10">
      ...
      <Section
        ...
        description="Basic identity details for this pet."
        icon={PawPrint}
      >
        <div className="grid gap-5 sm:grid-cols-2">
          <Field label="Pet Name" value={records.name} />
          <Field label="Species" value={records.species} />
          <Field label="Breed" value={records.breed} />
          <Field label="Sex" value={records.sex} />
          <Field label="Date of Birth" value={records.dateOfBirth} />
          <Field label="Age" value={ageLabel} />
          <Field label="Weight" value={records.weight} />
          <Field label="Color / Markings" value={records.color} />
          <Field
            label="Microchip Number"
            value={records.microchipId}
      ...
      >
        <div className="grid gap-5 sm:grid-cols-2">
          <Field label="Veterinary Clinic" value={records.veterinaryClinic} />
